...
/*
 * 
 * Project Creator: Prajwal Nangare
 * 
 * 
*/
...
public class Main {
    ...
    public static void menu() throws Exception {
        ...
        System.out.println(
                "\u001B[41m"
                        + "            *** Welcome to Psychologist Doctor Appointment System. Please Choose An appropriate Option. ***"
                        + "\u001B[0m");
        System.out.println("--------------------------------------------------------------------------------");
        ...
        System.out.println();
        System.out.println();
        System.out.println("1: For Psychologist Doctors");
...
class PsychologistDoctor {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("\n--------------------------------------------------------------------------------");
        System.out.println(
                "\u001B[41m" + "            *** Welcome PsychologistDoctor. Please Choose An appropriate Option. ***"
                        + "\u001B[0m");
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println();
        System.out.println();
        System.out.println("1: Login as PsychologistDoctor");
        System.out.println("2: Register as PsychologistDoctor");
    ...
    public static void login() throws Exception {
        try (Scanner myObj = new Scanner(System.in)) {
            ...
            Scanner fileScan = new Scanner(new File("PsychologistDoctorsDB.txt"));

            System.out.println("Enter Your UserName: ");
            String uName = myObj.nextLine();
            System.out.println("Enter Your Password: ");
            String pass = myObj.nextLine();
            String psychologistDocName = "";
            ...
            while (fileScan.hasNextLine()) {
                ...
                if ((Username.equals(uName)) && (Password.equals(pass))) {
                    ...
                    psychologistDocName = tempArr[0];
                }
            }
            if (found) {
                psychologistDoctorLoginMenu(uName, psychologistDocName);
            }
            if (!found) {
    ...
    public static void psychologistDoctorLoginMenu(String uName, String psychologistDocName) throws Exception {
        System.out.println("\n--------------------------------------------------------------------------------");
        System.out.println(
                "\u001B[41m"
                        + "            *** Welcome to PsychologistDoctor's Menu. Please Choose An appropriate Option. ***"
                        + "\u001B[0m");
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println();
        System.out.println();
        ...
        System.out.println("1: For All PsychologistDoctors List");
        ...
        switch (response) {
            case 1:
                allPsychologistDoctors();
                Thread.sleep(1000);
                psychologistDoctorLoginMenu(uName, psychologistDocName);
                break;
            case 2:
                bookedAppointments("Dr." + psychologistDocName);
                Thread.sleep(1000);
                psychologistDoctorLoginMenu(uName, psychologistDocName); // Booked Appointments
                break;
            case 3:
                Patient.allPatients();
                Thread.sleep(1000);
    ...
    // method for validating Strings from PsychologistDoctors
    ...
    // Method to register PsychologistDoctor
        ...
        try (Scanner obj = new Scanner(System.in)) {
            ...
            if (!validate(Uname)) {
                try {
                    ...
                    FileWriter fw = new FileWriter("PsychologistDoctorsDB.txt", true);
    ...
    // Method to view list of all PsychologistDoctors
    public static void allPsychologistDoctors() {
        try {
            System.out.println();
            System.out.println("\n--------------------------------------------------------------------------------");
            System.out.println(
                    "\u001B[41m"
                            + "            *** Welcome To PsychologistDoctors' List. Please Choose Wisely ***"
                            + "\u001B[0m");
            System.out.println("--------------------------------------------------------------------------------");
            System.out.println();
            System.out.println();
            File myObj = new File("PsychologistDoctorsDB.txt");
...
class Patient {
    ...
    public static void patientMenu(String uName, String patName) throws Exception {
        ...
        switch (response) {
            ...
            case 2:
                ...
                System.out.println("Enter the name of psychologistdoctor whose appointment you want to remove: ");
                String newPsychologistDoctor = newObj.nextLine();
                newPsychologistDoctor = newPsychologistDoctor.replace(" ", "_");
                newPsychologistDoctor = "Dr." + newPsychologistDoctor;
                String newString = uName + " " + newPsychologistDoctor;
    ...
    public static void bookAppointment(String Name, String patName) {
        ...
        System.out.println("2: Select PsychologistDoctor and Date of Appointment ");
        ...
        while (true) {
            ...
            try {
                ...
                switch (response) {
                    case 1:
                        PsychologistDoctor.allPsychologistDoctors();
    ...
    public static void appointment(String Name) {
        try (Scanner obj = new Scanner(System.in)) {
            System.out.println(
                    "Enter the name of the psychologist doctor whose appointment you want");
            String psychologistdoctor = obj.nextLine();
            ...
            getCCandReg(Name, psychologistdoctor, date, time);
        }

    }

    public static long getCCandReg(String Name, String psychologistdoctor, String date, String time) {
        long CreditCard = -1;
        while (true) {
            try {
        ...
        while (true) {
            if (validCc(CreditCard)) {
                ...
                String str = Name + " " + "Dr." + psychologistdoctor.replace(" ", "_") + " " + date + " " + time + "\n";
                try {
...
class Admin {
    ...
    static void adminMenu() throws Exception {
        ...
        System.out.println("1: View Registered PsychologistDoctors: ");
        System.out.println("2: View Registered Patients");
        System.out.println("3: View Appointments");
        System.out.println("4: Remove PsychologistDoctors");
        ...
        try {
            ...
            switch (response) {
                case 1:
                    PsychologistDoctor.allPsychologistDoctors();// View Registered PsychologistDoctors
                    Thread.sleep(1000);
                    adminMenu();
                    break;
                case 2:
                ...
                case 4:
                    Scanner newObj = new Scanner(System.in);
                    System.out.println("Enter the name of the psychologistdoctor you want to remove");
                    String psychologistdoctor = newObj.nextLine();
                    psychologistdoctor = psychologistdoctor.replace(" ", "_");
                    remove(psychologistdoctor);
                    adminMenu();
                    break;
                case 5:
    ...
    static void remove(String lineContent) {
        File originalFile = new File("PsychologistDoctorsDB.txt");
        File tempFile = new File("tempPsychologistDoctorsDB.txt");
